import { declarationCard } from '@/utils/common.utils';
import {
  Accordion,
  AccordionContent,
  AccordionPanel,
...
export function ClaimDeclarationCard() {
  const [isOpen, setIsOpen] = useState(false);

  return (
    <Accordion className="border-none bg-white hover:bg-white">
      <AccordionPanel>
        <AccordionTitle className="bg-white hover:bg-white focus:ring-transparent">
        ...
        <AccordionContent className="bg-white">
            ...
            <Table hoverable>
              ...
              <TableBody className="divide-y">
                <TableRow className="border-b-1 border-b-gray-200 bg-white dark:border-gray-700 dark:bg-gray-800">
                  ...
                  <TableCell>{declarationCard.deposit1}</TableCell>
                  <TableCell>
                    <HiPencil></HiPencil>
                  </TableCell>
                  <TableCell>
                ...
                <TableRow className="border-b-1 border-b-gray-200 bg-white dark:border-gray-700 dark:bg-gray-800">
                  ...
                  <TableCell>{declarationCard.deposit2}</TableCell>
                  <TableCell>
                    <HiPencil></HiPencil>
                  </TableCell>
                  <TableCell>
                ...
                <TableRow className="bg-white dark:border-gray-700 dark:bg-gray-800">
                  ...
                  <TableCell>{declarationCard.deposit3}</TableCell>
                  <TableCell>
                    <HiPencil></HiPencil>
                  </TableCell>
                  <TableCell>
          ...
          <div className="mt-4 rounded-b-lg bg-gray-50 p-5">
            ...
            { isOpen && <div className="mt-4 text-gray-500">
              <div className="text-sm lg:w-4/6">
                Please upload the relevant documents for your claim submission.
                Make sure your files are clear, complete, and meet the following
                requirements:
              </div>
              ...
              <div>
                <div className='italic text-xs mt-4 text-yellow-500'>There is no attachment, so nothing to show here.</div>
                <div id="fileUpload" className="w-full mt-3">
                  <FileInput id="file" />
                </div>
              </div>
            </div>}
